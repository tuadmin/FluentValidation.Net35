...
namespace FluentValidation.Tests {
  ...
  using System.Threading.Tasks;
	...
	public class InheritanceValidatorTest {
		...
		[Fact]
		public async System.Threading.Tasks.Task Validates_inheritance_async() {
			var validator = new InlineValidator<Root>();
			var impl1Validator = new InlineValidator<FooImpl1>();
			var impl2Validator = new InlineValidator<FooImpl2>();
		...
		[Fact]
		public async System.Threading.Tasks.Task Validates_collection_async() {
			var validator = new InlineValidator<Root>();
			var impl1Validator = new InlineValidator<FooImpl1>();
			var impl2Validator = new InlineValidator<FooImpl2>();
		...
		[Fact]
		public async System.Threading.Tasks.Task Validates_with_callback_async() {
			var validator = new InlineValidator<Root>();
			var impl1Validator = new InlineValidator<FooImpl1>();
			var impl2Validator = new InlineValidator<FooImpl2>();
		...
		[Fact]
		public async System.Threading.Tasks.Task Validates_with_callback_accepting_derived_async() {
			var validator = new InlineValidator<Root>();
			var impl1Validator = new InlineValidator<FooImpl1>();
			var impl2Validator = new InlineValidator<FooImpl2>();
		...
		[Fact]
		public async System.Threading.Tasks.Task Validates_ruleset_async() {
			var validator = new InlineValidator<Root>();
			var impl1Validator = new InlineValidator<FooImpl1>();
			var impl2Validator = new InlineValidator<FooImpl2>();
