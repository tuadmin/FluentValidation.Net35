...
namespace FluentValidation.Tests {
	...
	public class RuleDependencyTests {
		...
		[Fact]
		public async System.Threading.Tasks.Task Async_inside_dependent_rules() {
		...
		[Fact]
		public async System.Threading.Tasks.Task Async_inside_dependent_rules_when_parent_rule_not_async() {
